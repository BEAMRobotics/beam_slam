  ...
  */
  ...
  auto constraint = beam_constraints::global::
      AbsoluteImuState3DStampedConstraint::make_shared(
          "test", *orientation_variable, *velocity_variable, *position_variable,
          *acceleration_bias_variable, *gyroscope_bias_variable, mean, cov);
  ...
  fuse_core::MatrixXd cov_vel_pos(velocity_variable->size(),
                                  position_variable->size());
  covariance.GetCovarianceBlock(velocity_variable->data(),
                                position_variable->data(), cov_vel_pos.data());
  ...
  fuse_core::MatrixXd cov_ba_bg(acceleration_bias_variable->size(),
                                gyroscope_bias_variable->size());
  covariance.GetCovarianceBlock(acceleration_bias_variable->data(),
                                gyroscope_bias_variable->data(),
                                cov_ba_bg.data());
  ...
  actual_covariance << cov_or_or, cov_or_vel, cov_or_pos, cov_or_ba, cov_or_bg,
      cov_or_vel.transpose(), cov_vel_vel, cov_vel_pos, cov_vel_ba, cov_vel_bg,
      cov_or_pos.transpose(), cov_vel_pos.transpose(), cov_pos_pos, cov_pos_ba,
      cov_pos_bg, cov_or_ba.transpose(), cov_vel_ba.transpose(),
      cov_pos_ba.transpose(), cov_ba_ba, cov_ba_bg, cov_or_bg.transpose(),
      cov_vel_bg.transpose(), cov_pos_bg.transpose(), cov_ba_bg.transpose(),
      cov_bg_bg;
...
TEST(AbsoluteImuState3DStampedConstraint, Serialization) {
  ...
  beam_constraints::global::AbsoluteImuState3DStampedConstraint expected(
      "test", *(data_.orientation1), *(data_.velocity1), *(data_.position1),
      *(data_.accelbias1), *(data_.gyrobias1), data_.mean, data_.cov);
