...
GraphFrameInitializer::GraphFrameInitializer(const std::string& sensor_frame_id,
...
void GraphFrameInitializer::UpdatePose(fuse_core::Graph::ConstSharedPtr graph) {
