...
const Eigen::Vector3d& IMUInitializer::bg() {
  return bg_;
}

const Eigen::Vector3d& IMUInitializer::ba() {
  return ba_;
}

const Eigen::Vector3d& IMUInitializer::gravity() {
  return gravity_;
}

const double& IMUInitializer::scale() {
  return scale_;
}
