...
class VisualConstraintFixed : public fuse_core::Constraint {
public:
  FUSE_CONSTRAINT_DEFINITIONS(VisualConstraintFixed);

  /**
   * @brief Default constructor
   */
  VisualConstraintFixed() = default;
   ...
   * @brief Destructor
   */
  virtual ~VisualConstraintFixed() = default;
...
BOOST_CLASS_EXPORT_KEY(fuse_constraints::VisualConstraintFixed);